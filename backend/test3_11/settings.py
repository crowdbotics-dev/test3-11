"""
Django settings for test3_11 project.
...
WSGI_APPLICATION = 'test3_11.wsgi.application'
...
SPECTACULAR_SETTINGS = {
    ...
    "TITLE": "test3_11 API",
    "DESCRIPTION": "API documentation for test3_11 App",
    "VERSION": "v1",
}
